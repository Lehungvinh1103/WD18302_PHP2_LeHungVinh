<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php __DIR__?>/public/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="<?php __DIR__?>/public/assets/img/favicon.png">
  <title>
    <?= $title ?>
  </title>
  <!--     Fonts and icons     -->
