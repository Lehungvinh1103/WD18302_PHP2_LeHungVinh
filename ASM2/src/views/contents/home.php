                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownAct">
                      <form id="formDownload" action="downloadFile" class="dropdown-item" method="post" enctype="multipart/form-data">
                        ...
                        <button class="border-0" type="submit"><i class="bi bi-download me-1"></i><span class="font-weight-bold">Tải xuống</span></button>
                      </form>
                      ...
                      <form id="formRemove" action="moveToBin" class="dropdown-item" method="post" enctype="multipart/form-data">
                        <input type="text" hidden name="file_id" value="<?= $fileItems['file_id'] ?>">
                        <button class="border-0" type="submit"> <i class="bi bi-trash me-1"></i><span class="font-weight-bold">Thùng rác</span>
                        </button>
                      </form>
                      <li class="dropdown-item">
                        <button class="border-0 edit-btn" data-bs-toggle="modal" data-bs-target="#modalRename_<?= $fileItems['file_id']?>"><i class="bi bi-pencil-square me-2"></i><span class="font-weight-bold">Rename</span></button>
                      </li>
              ...
              <div class="modal fade" id="modalRename_<?= $fileItems['file_id']?>" tabindex="-1" role="dialog" aria-labelledby="modalRenameLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <form method="post" action="renameFile" enctype="multipart/form-data">
                      <div class="modal-body">
                        <div class="form-group mb-0">
                          <input type="text" hidden name="file_id" value="<?= $fileItems['file_id'] ?>">
                          <input type="text" hidden name="old_file_name" value="<?= $fileItems['file_name'] ?>">
                          <input type="text" hidden name="file_ex" value="<?= $file_ex ?>">
                          <input type="text" name="file_name" id="file_name" value="<?= $file_name ?>" class="account-file-input form-control" multiple />
